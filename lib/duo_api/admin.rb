...
class DuoApi
  ...
  class Admin < DuoApi
    ...
    def create_integration(name:, type:, **optional_params)
      ...
      #                  adminapi_subaccount_accounts, adminapi_subaccount_accounts_read,
      #                  adminapi_subaccount_admins, adminapi_subaccount_admins_read, adminapi_subaccount_info,
      #                  adminapi_subaccount_integrations, adminapi_subaccount_integrations_read,
      #                  adminapi_subaccount_settings, adminapi_subaccount_settings_read, adminapi_subaccount_read_log,
      #                  adminapi_subaccount_read_resource, adminapi_subaccount_write_resource,
      #                  adminapi_subaccount_allow_to_set_permissions, adminapi_subaccount_user_limits,
      #                  adminapi_subaccount_user_limits_read, enroll_policy, greeting, groups_allowed, ip_whitelist,
